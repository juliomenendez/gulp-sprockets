...
function getSubdirs(rootPath) {
  try {
    return (0, _klawSync2.default)(rootPath, { nofile: true }).map(function (p) {
      return _path2.default.resolve(p.path);
    });
  } catch (e) {
    return [];
  }
...
var Assets = exports.Assets = function () {
  ...
  _createClass(Assets, [{
    ...
    value: function init(assetPaths) {
      assetPaths = (0, _objectAssign2.default)(defaultAssetPaths(), assetPaths);
      ...
      _lodash2.default.forEach(this._javascriptPaths, function (p) {
        deepJavascriptPaths = _lodash2.default.concat(deepJavascriptPaths, getSubdirs(p));
      });
      this._javascriptPaths = _lodash2.default.concat(this._javascriptPaths, deepJavascriptPaths);
    ...
    value: function findJavaScript(filePath) {
      var isFullPath = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
    ...
    value: function _find(filePath, assetPaths, extnames) {
      ...
      if (assetPaths && assetPaths.length) {
        res = _lodash2.default.uniq(_lodash2.default.flatten(assetPaths.map(function (p) {
    ...
    value: function _autoExtname(filePath, extname) {
      if (_path2.default.extname(filePath) !== extname) {
